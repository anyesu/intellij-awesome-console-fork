...
public class MultipleFilesHyperlinkInfo extends HyperlinkInfoBase implements FileHyperlinkInfo {
    ...
    public MultipleFilesHyperlinkInfo(@NotNull List<? extends VirtualFile> virtualFiles, int lineNumber, @NotNull Project project) {
        this(virtualFiles, lineNumber, project, null);
    }

    public MultipleFilesHyperlinkInfo(@NotNull List<? extends VirtualFile> virtualFiles,
                                      int lineNumber,
